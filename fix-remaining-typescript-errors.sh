...
# Comprehensive fix for all TypeScript build errors

echo "Applying comprehensive TypeScript fixes..."

# Fix HITLReview.tsx
echo "Creating fixed HITLReview.tsx..."
cat > /Users/tvonlinz/3cubed-seo/src/pages/HITLReview.tsx << 'EOF'
...
# Fix SEORequests.tsx and Submissions.tsx - remove unique_id
...
# Fix SEOReview.tsx - Create a cleaned version
echo "Creating fixed SEOReview.tsx..."
cat > /Users/tvonlinz/3cubed-seo/src/pages/SEOReview.tsx << 'EOF'
import { useState } from 'react'
import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query'
import { supabase, type Submission } from '../lib/supabase'
