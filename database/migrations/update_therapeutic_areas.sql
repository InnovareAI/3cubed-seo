-- Migration to update therapeutic_area to use top 15 common disease areas plus Others

-- First, let's check what therapeutic areas are currently in use
SELECT DISTINCT therapeutic_area, COUNT(*) as count 
FROM submissions 
GROUP BY therapeutic_area 
ORDER BY count DESC;

-- Add a CHECK constraint for therapeutic_area to ensure only valid values
-- First, we need to update existing values to match our new standard list
UPDATE submissions 
