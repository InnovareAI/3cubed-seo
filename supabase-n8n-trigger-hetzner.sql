-- Supabase → N8N Trigger Setup (Hetzner Cloud)
...
BEGIN
  ...
  -- Make HTTP POST request to N8N workflow on Hetzner
  -- Replace YOUR_HETZNER_DOMAIN with your actual domain/IP
  SELECT status INTO response_status
  FROM http_post(
    'https://workflows.innovareai.com/webhook/fda-research-agent',
    payload::text,
    'application/json'
  );
