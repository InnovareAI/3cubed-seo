...
export default function ClientReview() {
  ...
  const handleReject = (id: string) => {
    const feedbackText = feedback[id] || 'Please revise based on client feedback'
    updateSubmission.mutate({
      id,
      updates: {
  ...
  if (!submissions || submissions.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-2 text-sm text-gray-500">All submissions have been reviewed by clients.</p>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      <div className="bg-white shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-medium text-gray-900">Client Review Queue</h2>
          <p className="mt-1 text-sm text-gray-500">
            Content approved by SEO team, pending client review
          </p>
        </div>
                ...
                <div className="mt-6 space-y-6">
                  {submission.ai_output && (
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-gray-900 mb-2">SEO Approved Content</h4>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Client Feedback (if requesting changes)
                    </label>
                    <textarea
